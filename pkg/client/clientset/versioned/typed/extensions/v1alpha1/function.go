...
import (
	...
	scheme "github.com/hyperfunction/hyperfunction/pkg/client/clientset/versioned/scheme"
...
func newFunctions(c *ServingV1alpha1Client, namespace string) *functions {
	return &functions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *functions) UpdateStatus(ctx context.Context, function *v1alpha1.Function, opts v1.UpdateOptions) (result *v1alpha1.Function, err error) {
	result = &v1alpha1.Function{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("functions").
