...
import (
	...
	extensionsv1alpha1 "github.com/hyperfunction/hyperfunction/pkg/apis/extensions/v1alpha1"
	...
	v1alpha1 "github.com/hyperfunction/hyperfunction/pkg/client/listers/extensions/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1alpha1().Functions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1alpha1().Functions(namespace).Watch(context.TODO(), options)
			},
		},
