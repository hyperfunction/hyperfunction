...
import (
	...
	versionedscheme "github.com/hyperfunction/hyperfunction/pkg/client/clientset/versioned/scheme"
	client "github.com/hyperfunction/hyperfunction/pkg/client/injection/client"
	function "github.com/hyperfunction/hyperfunction/pkg/client/injection/informers/core/v1alpha1/function"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "functions.core.hyperfunction.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	functionInformer := function.Get(ctx)

	lister := functionInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "core.hyperfunction.dev.Function"),
	)
