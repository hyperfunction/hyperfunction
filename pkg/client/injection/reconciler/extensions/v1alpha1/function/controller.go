...
import (
	...
	function "github.com/hyperfunction/hyperfunction/pkg/client/injection/informers/extensions/v1alpha1/function"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "functions.serving.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "serving.knative.dev.Function"),
	)
